<template>
  ...
  height: auto;
  background-color: rgba(255, 255, 255, 0.15);width: 40.5%">
      <div style="display: flex; justify-content: center; align-items: center;margin-top: 15px;">
        <div>
          <img src='http://cdn.onlinewebfonts.com/svg/img_212716.png' style="width: 60px; height: 60px;" />
        </div>
        <div>
          <h5 style='font-size: 24px; font-weight: bold; color: #fff; margin-left: 5px; font-family: arrowFONT; margin-top: 10px;'>
            გიორგი ბოცვაძე
          </h5>
          <h5 style='font-size: 16px; font-weight: bold; color: #fff; margin-left: 5px; font-family: arrowFONT;'>
            ოთახის ნომერი: <span style='font-size: 20px; color: #1F9EE5; font-family: arrowFONT; font-weight: bold;'>U234874</span>
          </h5>
        </div>
      </div>
      ...
      <div style='display: flex; margin-top: 40px; justify-content: space-between;'>
        <div style='align-items: center; text-align: center; margin-left: 20px;'>
          <h5 style='font-weight: bold; font-family: arrowFONT; font-size: 20px; color: #fff;'>ბალანსი</h5>
          <h5 style='font-weight: bold; font-family: arrowFONT; font-size: 22px; color: #009CE7; letter-spacing: 2px;'>15&#8382; </h5>
        ...
        <div style='align-items: center; text-align: center;margin-right: 20px;'>
          <h5 style='font-weight: bold; font-family: arrowFONT; font-size: 20px; color: #fff;'>გადასახდელი</h5>
          <h5 style='font-weight: bold; font-family: arrowFONT; font-size: 22px; color: #009CE7; letter-spacing: 2px;'>0&#8382; </h5>
